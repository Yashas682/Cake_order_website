...
<link rel="stylesheet" type="text/css" href="css/add_food_items2.css">
...
<body>
  ...
  <div class="container">
    <div class="jumbotron">
      <h1>Hello Manager! </h1>
      <p>Manage your Cake Shop from here</p>
  ...
  <div class="container">
    ...
    <div class="col-xs-3" style="text-align: center;">
      ...
      <div class="list-group">
        <a href="myrestaurant.php" class="list-group-item ">My Cake Shop</a>
        <a href="add_food_items.php" class="list-group-item active">Add Cakes</a>
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        <form action="add_food_items1.php" method="POST">
          <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;"> ADD NEW CAKES HERE </h3>
          ...
          <div class="form-group">
            <button type="submit" id="submit" name="submit" class="btn btn-primary pull-right"> ADD CAKES </button>
          </div>
        </form>
